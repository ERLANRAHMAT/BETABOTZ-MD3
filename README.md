...
- Setelah mendapatkan apikey silahkan paste di config.js pada bagian ```global.btz```
...
<a href="https://api.betabotz.eu.org/donasi" target="_blank"><img src="https://img.shields.io/badge/Buy_Me_A_Coffee-FFDD00?style=for-the-badge&logo=buy-me-a-coffee&logoColor=black" height="32px" alt="Donate"></a>
...
```javascript
git clone https://github.com/ERLANRAHMAT/BETABOTZ-MD3
cd BETABOTZ-MD3
npm i
npm start
```
